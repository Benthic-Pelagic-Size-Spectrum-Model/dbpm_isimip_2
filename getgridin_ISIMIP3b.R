...
# getgridin_withspinup <- function(igrid, curr_scen, save_path_obsclim, save_path_ctrlclim, ctrlclim, obsclim){
#   
#   # trial 
#   # igrid = 1
#   
...
#     # gridinputs_obsclim <- lazy_dt(obsclim[curr_grid_obsclim,])
#     # gridinputs_ctrlclim <- lazy_dt(ctrlclim[curr_grid_ctrlclim,])
#     
...
#     new_t<-seq((t[1]-length(new_date)),t[1]-1) # here problem with lazy_dt otherwise ...
#     # new_t<-seq((720-length(new_date)),720-1)
#     new_date_df<-lazy_dt(data.frame(Date = new_date, t = new_t))
#     rm(new_date, t, new_t)
#     
...
#       arrange(Date)
#     
#     # gridinputs_ctrlclim<-as.data.frame(gridinputs_ctrlclim)
#     
#     # check - OK 
...
#       arrange(Date) # %>% 
#     
#     # gridinputs_obsclim<-as.data.frame(gridinputs_obsclim)
#     
