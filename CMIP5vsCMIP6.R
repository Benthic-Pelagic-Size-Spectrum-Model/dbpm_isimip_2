...
rm(list=ls())
# call plotMaps.r # both files should be moved to the Fishmip repository instead of being in the DBPM folder/project  
...
dim(fut)
# very high values for last month of projections (similar for historical for last keek - need to understand why)
...
# pdf("IPSL_CMIP5_all.pdf", height=20, width=20) # ssp126, ssp585, trends ssp585 
tiff("IPSL_CMIP5_all.tiff", height=20, width=20, units ='in', res=300)
(gg_map_cmip5[[1]]+gg_map_cmip5[[2]]+gg_ts_cmip5[[2]])/ # apecosm DONE, but no CMIP6 counterpart
  (gg_map_cmip5[[3]]+gg_map_cmip5[[4]]+gg_ts_cmip5[[4]])/ # boats DONE, but no CMIP6 counterpart  
  # (gg_map_cmip5[[5]]+gg_map_cmip5[[6]]+gg_ts_cmip5[[6]])/ # dbem TO DO
  (gg_map_cmip5[[7]]+gg_map_cmip5[[8]]+gg_ts_cmip5[[8]])/ # dbpm   
